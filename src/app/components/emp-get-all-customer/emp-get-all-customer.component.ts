...
@Component({
  selector: 'app-emp-get-all-customer',
  templateUrl: './emp-get-all-customer.component.html',
  styleUrls: ['./emp-get-all-customer.component.css']
})
export class EmpGetAllCustomerComponent implements OnInit {
